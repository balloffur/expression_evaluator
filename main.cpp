...
std::map<std::string, actions> what_to_do{
{"show", show_number}, {"reset", reset}, {"e",EVAL}, {"eval", EVAL}, {"inverse", MODULAR_INVERSE},
{"egcd", EGCD}, {"nod", number_of_digits}, {"countdigits", number_of_digits}, {"primorial", primorial},
{"demofib", demofib}, {"fib", fib}, {"primes", demoprimes}, {"powmod", to_powmod_bigint},
{"gcdall", gcdall}, {"bintohex", bintohex}, {"bintodec", bintodec}, {"dectohex", dectohex},
