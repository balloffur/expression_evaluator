...
echo.
echo [1/8] Compiling debug versions...
...
echo [2/8] Compiling release versions...
...
echo [6/8] Running bigint_extra_test (release)...
echo. >> test_results.txt
