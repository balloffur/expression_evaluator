@echo off
echo ========================================
echo Compiling and Testing bigint_extra_test
echo ========================================

REM Check if source file exists
if not exist "bigint_extra_test.cpp" (
    echo Error: bigint_extra_test.cpp not found!
    pause
    exit /b 1
)
...
echo Debug version compiled successfully: bigint_extra_test_debug.exe
...
echo Release version compiled successfully: bigint_extra_test_release.exe
...
echo ----------------------------------------
bigint_extra_test_debug.exe --verbose --benchmark --no-exceptions
if %errorlevel% neq 0 (
...
echo ----------------------------------------
bigint_extra_test_release.exe --verbose --benchmark --no-exceptions
if %errorlevel% neq 0 (
...
echo Test Summary
echo ========================================
echo Debug executable:   bigint_extra_test_debug.exe
echo Release executable: bigint_extra_test_release.exe
echo.
